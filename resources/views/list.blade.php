...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/slider.css?version=41">
...
&lt;/head&gt;
&lt;body&gt;
&lt;p&gt;&lt;u&gt;<span style="color: #fff;">Ordered list:-</span>&lt;/u&gt;&lt;/p&gt;
&lt;ol <span class="attributes">type</span>="<select onchange="typefun()" id="type"><option>1</option><option>A</option><option>a</option><option>I</option><option>i</option></select>"&gt;
  &lt;li&gt;<span style="color: #fff">Apple</span>&lt;/li&gt;
  &lt;li&gt;<span style="color: #fff">Orange</span>&lt;/li&gt;
  &lt;li&gt;<span style="color: #fff">Mango</span>&lt;/li&gt;
&lt;/li&gt;
&lt;/ol&gt;

&lt;p&gt;&lt;u&gt;<span style="color: #fff;">Un-ordered list:-</span>&lt;/u&gt;&lt;/p&gt;
&lt;ul <span class="attributes">type</span>="<select onchange="type1fun()" id="type1"><option>disc</option><option>circle</option><option>square</option><option>none</option></select>"&gt;
  &lt;li&gt;<span style="color: #fff">Apple</span>&lt;/li&gt;
  &lt;li&gt;<span style="color: #fff">Orange</span>&lt;/li&gt;
  &lt;li&gt;<span style="color: #fff">Mango</span>&lt;/li&gt;
&lt;/li&gt;
...
<span class="tags">ol</span>
{
  ...
  <span class="css">border:</span><input style="position: relative;top:8px;z-index: 2;" id="border" type="range" min="0" max="100" value="1" onchange="borderfun()"><span id="border-value" class="rangeval">0px</span>
...
<span class="text text-warning">/* same css can be applied for ul and li tags */</span>
...
ol
{
  ...
  border:<span id="border_value">0px</span>;
  ...
  padding:<span id="padding_value"></span>;
  margin:<span id="margin_value"></span>;
...
&lt;ol type="<span id="type_value">1</span>"&gt;
  &lt;li&gt;Apple&lt;/legend&gt;
  &lt;li&gt;Orange&lt;/legend&gt;
  &lt;li&gt;Mango&lt;/legend&gt;
&lt;/ol&gt;
&lt;p&gt;&lt;u&gt;Un-ordered list:- &lt;/u&gt; &lt;/p&gt;
&lt;ul type="<span id="type1_value">disc</span>"&gt;
  &lt;li&gt;Apple&lt;/legend&gt;
  &lt;li&gt;Orange&lt;/legend&gt;
  &lt;li&gt;Mango&lt;/legend&gt;
&lt;/ul&gt;
...
<div class="tab-content">
    ...
    <div class="container1">
      <p style="font-size: 16px!important;"><i><u>Ordered list:-</u></i></p>
      <ol id="anchor" style="transition: 0.5s" type="1">
        <li>Apple</li>
        <li>Orange</li>
        <li>Mango</li>
      </ol>
      <p><i><u>Un-ordered list:-</u></i></p>
      <ul id="anchor1">
        <li>Apple</li>
        <li>Orange</li>
        <li>Mango</li>
...
//=================================reset-browser======================================= 
    document.getElementById('anchor').style.margin='';
    ...
    document.getElementById('anchor').style.border="0px";//reset border
    document.getElementById('anchor').style.borderColor='#ccc';//reset image border-color
    document.getElementById('anchor').style.borderRadius='';//reset radius of image
    ...
    document.getElementById('anchor').style.position="";
    document.getElementById('anchor').style.filter="none";//reset filter
    document.getElementById('anchor').type="1";
    document.getElementById('anchor1').type="disc";
    document.getElementById('anchor').style.padding='';//reset padding
...
//===============================Reset values in source code==========================================================//
    ...
    document.getElementById("size_value").innerHTML="unset";
...
//==================================display required css only=======================================================//
   ...
   function positionfun()
        ...
        function typefun()
        {
          var logs = "you have set ordered list type as:"
          var value = document.getElementById('type').value;
            document.getElementById('anchor').type=value;
           document.getElementById('type_value').innerHTML=value;
           document.getElementById('Logs').innerHTML +="<p>"+ ++i +">>"+logs+" "+value+"</p>"+"\n";
        }
         function type1fun()
        {
          var logs = "you have set un-ordered list type as:"
          var value = document.getElementById('type1').value;
            document.getElementById('anchor1').type=value;
           document.getElementById('type1_value').innerHTML=value;
           document.getElementById('Logs').innerHTML +="<p>"+ ++i +">>"+logs+" "+value+"</p>"+"\n";
          //document.getElementById('frame').style.display="block";
        }
         function cursorfun()
  ...
  function heightfun(){
    ...
    {
      var custom = prompt("Enter value in px (or) % Eg:30px or 30%:");
  ...
  function widthfun(){
    ...
    {
      var custom = prompt("Enter value in px (or) % Eg:40px or 40%:");
