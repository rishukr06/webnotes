...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../slider.css?version=41">
...
&lt;a <span class="attributes">href</span><span style="color: #fffcc0">="<select id="href" onchange="hreffun()"><option>webnotes</option><option>custom</option></select>"</span>&gt;<span style="color: #fff"><span class="tags">&lt;button&gt;</span>Button<span class="tags">&lt;/button&gt;</span></span>&lt;/a&gt;
...
<span class="tags">a</span>{<span class="css">text-decoration:none</span>}
<span class="tags">button</span>
{
  ...
  <span class="css">border:</span><input class="range" id="border" type="range" min="0" max="100" value="0" onchange="borderfun()"><span id="border-value" class="rangeval">0px</span>
  ...
  <span class="css">color:</span><input style="position: relative;top:8px;" type="color" id="color" onchange="colorfun()" value="#0000FF">
  ...
  <span class="css">font-size:</span><input class="range" id="size" type="range" min="0" max="100" value="0" onchange="sizefun()"><span id="size-value" class="rangeval">unset</span>

  <span class="css">border-radius:</span><input class="range" id="radius" type="range" min="1" max="100" value="1" onchange="radiusfun()"><span id="radius-value" class="rangeval">unset</span>

   <span class="css">box-shadow:</span>h-offset <input onchange="filterfun()" id="hoffset" class="range" type="range" min="-150" max="150" value="0"><span id="hoffset-value" class="rangeval">unset</span>

              v-offset <input id="voffset" onchange="filterfun()" class="range" type="range" value="0" min="-150"  max="150"><span id="voffset-value" class="rangeval">unset</span>

              blur <input id="sblur" onchange="filterfun()" class="range" type="range" value="0" min="0"  max="100"><span id="sblur-value" class="rangeval">unset</span>
  ...
  <span class="css">margin:</span><input class="range" id="margin" type="range" min="0" max="100" value="0" step='1' onchange="marginfun()"><span id="margin-value" class="rangeval">0px</span>
...
button
{
  ...
  text-decoration:<span id="decoration_value"></span>;
  border:<span id="border_value">0</span>;
  background:<span id="bgcolor_value"></span>;
  color:<span id="color_value">blue</span>;
  font-size:<span id="size_value"></span>;
...
&lt;body&gt;
 ...
 &lt;a href="<span id="href_value">#Enter_Your_Pag_Url_Here#</span>"&gt;&lt;button&gt;Button&lt;/button&gt;&lt;/a&gt;
...
<div class="tab-content">
    ...
    <div class="container1">
      <a id="a" style="position: relative;display:block;color: black;text-decoration: none;"  href="/welcome" onclick="linkfun()" target="frame"><button style="transition: 0.5s" id="anchor">Button</button></a>
      <span id="browser" style="position:relative;top:9vh;display: none; font-family: sans-serif;font-size: 16px;">your linked next page:</span>
      <iframe  id="frame" name="frame" style="position: relative;top:10vh;width:100vh;height: 40vh;display: none;"></iframe>
    </div>
  </div>
...
//=================================reset-browser======================================= 
    ...
    //document.getElementById('heading').style.width='auto';//reset width 
    //document.getElementById('heading').style.height='auto';//reset height
    document.getElementById('anchor').style.textAlign="left";//reset alignment
     document.getElementById('anchor').style.position="unset";
    //document.getElementById('heading').style.transform='none';//reset image transformation
    //document.getElementById('heading').style.transition="0.5s"//reset speed
    document.getElementById('anchor').style.filter="none";//reset filter
    //document.getElementById('anchor').style.boxShadow="0px 0px 0px red";//reset filter
    document.getElementById('anchor').style.padding=0;//reset padding
    document.getElementById('frame').style.display="none";
    document.getElementById('browser').style.display="none";
    document.getElementById('anchor').style.backgroundColor="";//reset bgcolor
    document.getElementById('anchor').style.color="black";//reset color
    document.getElementById('anchor').style.fontSize='';//reset size
    document.getElementById('a').href='http://localhost/project_X/';
...
//===============================Reset values in source code==========================================================//
    ...
    document.getElementById("align_value").innerHTML="left";
     ...
     document.getElementById('margin_value').innerHTML='0px';
    ...
    document.getElementById("bgcolor_value").innerHTML="";
    document.getElementById("size_value").innerHTML="";
...
//==================================display required css only=======================================================//
   ...
   function linkfun()
    ...
    if(value!='custom')
    {
      document.getElementById('a').href=value;
      document.getElementById('Logs').innerHTML +="<p>"+ ++i +">>"+logs+" "+value+"</p>"+"\n";
    }
    else
    {
      var custom = prompt("Enter url");
      document.getElementById('a').href=custom;
  ...
  function heightfun(){
    var logs="you have changed the value of heading height to";
    var value = document.getElementById('height').value;
    if(value!='custom')
    {
      document.getElementById('heading').style.height=value;
    ...
    else
    {
      ...
      document.getElementById('heading').style.height=custom;
      document.getElementById("height_value").innerHTML=custom;
      document.getElementById('Logs').innerHTML +="<p>"+ ++i +">>"+logs+" "+custom+"</p>"+"\n";
    }
  }
  function widthfun(){
    var logs="you have changed the value of heading width to";
    var value = document.getElementById('width').value;
    if(value!='custom')
    {
      document.getElementById('heading').style.width=value;
