...
&lt;a <span class="attributes">href</span><span style="color: #fffcc0">="<select id="href" onchange="hreffun()"><option>webnotes</option><option>custom</option></select>"</span>&gt;<span style="color: #fff">click me!</span>&lt;/a&gt;
...
<span class="tags">a</span>
{
  ...
  <span class="css">border:</span><input style="position: relative;top:8px;z-index: 2;" id="border" type="range" min="0" max="100" value="0" onchange="borderfun()"><span id="border-value" class="rangeval">0px</span>
...
a
{
  ...
  background:<span id="bgcolor_value">transparent</span>;
...
&lt;body&gt;
 ...
 &lt;a href="<span id="href_value">#Enter_Your_Pag_Url_Here#</span>"&gt;click me!&lt;/a&gt;
...
<div class="tab-content">
    ...
    <div class="container1">
      <a style="transition: 0.5s;position: relative;display:block;color: blue;text-decoration: underline;" id="anchor" href="/welcome" onclick="linkfun()" target="frame">click me!</a>
...
//=================================reset-browser======================================= 
    ...
    document.getElementById('anchor').border="0px";//reset border
    ...
    document.getElementById('anchor').style.backgroundColor="transparent";//reset bgcolor
    document.getElementById('anchor').style.color="blue";//reset color
    ...
    document.getElementById('anchor').style.textDecoration='underline';//reset text-decoration
...
//===============================Reset values in source code==========================================================//
    ...
    document.getElementById("bgcolor_value").innerHTML="transparent";
    document.getElementById("size_value").innerHTML="";
    document.getElementById("decoration_value").innerHTML="unset";
